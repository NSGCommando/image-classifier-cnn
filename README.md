...
- Model weights stored at `/models/` as `.keras` files
- Model best accuracy stored at `/results/eval_accuracy.txt`
...
## Future Plans ##
- Implement batch file for easier inference
- Implement batch file for easier training
